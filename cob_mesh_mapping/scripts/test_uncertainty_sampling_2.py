...
xx1 = (-1.,3.)
xx2 = (0.,5.)
X1,X2 = meshgrid(linspace(xx1[0],xx1[1],80),linspace(xx2[0],xx2[1],80))
...
cs1 = ax1.contour(X1,X2,det1,20,colors='k')
ax1.imshow(det1,extent=[xx1[0],xx1[1],xx2[0],xx2[1]],origin='lower',cmap=plt.cm.YlOrRd)
...
cs2 = ax2.contour(X1,X2,det2,20,colors='k')
ax2.imshow(det2,extent=[xx1[0],xx1[1],xx2[0],xx2[1]],origin='lower',cmap=plt.cm.YlOrRd)
